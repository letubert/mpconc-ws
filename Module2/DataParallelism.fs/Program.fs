...
let pageRankDemo() =
    ...
    [
       ...
       // TODO : 2.11
       // complete map reduce and than run this
       //    "F# PSeq",              (run (fsWrapper <| MapReduceFsPSeq.mapReduce))
       "C# PLINQ Partitioner", (run (csWrapper <| MapReducePLINQ.MapReduce))
    ]
    ...
    // TODO : 2.11
    // complete map reduce and than run this
    // uncomment after have completed the Map-Reduce function implementation
    let ranks =
        execute 100 (csWrapper <| MapReducePLINQ.MapReduce)
